# TFT_DDIG
TFT_DDIG was made (Adapted from the UTFT_DDIG library) to improve the display response time of seven-segment numbers, the accepted value is between 0-9 and 10-15 (A-F)
